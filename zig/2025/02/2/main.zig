...
test "parseRange with example" {
    ...
    try std.testing.expectEqual(210, parseRange("95-115"));
    try std.testing.expectEqual(2009, parseRange("998-1012"));
    ...
    try std.testing.expectEqual(565656, parseRange("565653-565659"));
    try std.testing.expectEqual(824824824, parseRange("824824821-824824827"));
    try std.testing.expectEqual(2121212121, parseRange("2121212118-2121212124"));
}
...
test "processResult with example" {
    ...
    try std.testing.expectEqual(4174379265, processResult(&reader));
}
